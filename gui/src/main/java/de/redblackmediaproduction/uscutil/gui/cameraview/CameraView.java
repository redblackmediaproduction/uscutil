package de.redblackmediaproduction.uscutil.gui.cameraview;
...
public class CameraView implements Initializable {
    @FXML
                    ...
                    try {
                        if ((grabbedImage = selWebCam.getImage()) != null) {
                            ...
                            Platform.runLater(() -> {
                                ...
                                //Recognizer.readMrz(matConverter.convertToMat(frameConverter.getFrame(grabbedImage)));
                            });
